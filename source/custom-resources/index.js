...
exports.handler = async (event, context) => {
  ...
  try {
    ...
    switch (resource) {
      /* ffmpeg */
      case 'ShouldUseFFmpeg':
        handler = require('./lib/ffmpeg').ShouldUseFFmpeg;
        break;
      /* s3 */
      ...
      case 'PrivateWorkforceConfiguration':
        handler = require('./lib/sagemaker').PrivateWorkforceConfiguration;
        break;
      default:
        break;
    }
