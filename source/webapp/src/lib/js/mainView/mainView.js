...
import WorkteamTab from './tabControllers/workteamTab.js';
...
export default class MainView {
  constructor() {
    ...
    this.$workteamTab = new WorkteamTab();
  }
  ...
  async show() {
    ...
    this.trainingTab.eventSource.on(TrainingTab.Events.Tab.Switch.LabelingTeam, async () =>
      this.workteamTab.setActive());
  ...
  createLogo() {
    const solutionLink = $('<a/>').addClass('navbar-brand')
      ...
      .css('font-size', '1rem')
      .tooltip();
    return solutionLink.append($('<i/>').addClass('far fa-object-ungroup d-inline-block')
      .css('font-size', '2rem'));
  }
